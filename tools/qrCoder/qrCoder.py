...
def qrCoder(qrData, qrVersion, qrErrorCorrection, qrBoxSize, qrBorder, qrFit, qrOutput):
   if qrData is "":
   ...
   print qrErrorCorrection, Constants.LOW
...
def main():
   ...
   qrCoder(argumentList.qrData, argumentList.qrVersion, argumentList.qrErrorCorrection, argumentList.qrBoxSize, argumentList.qrBorder, argumentList.qrFit, argumentList.qrOutput)
